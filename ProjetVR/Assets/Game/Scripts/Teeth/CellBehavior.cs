    ...
    private void SetMaterials(TeethState state)
    {
        switch (state)
        {
            case TeethState.Clean:
                mR.material = toothManager.cleanMaterial;
                break;
            case TeethState.Dirty:
                mR.material = toothManager.dirtyMaterial;
                break;
            case TeethState.Tartar:
                mR.material = toothManager.tartarMaterial;
                break;
            case TeethState.Decay:
                mR.material = toothManager.decayMaterial;
                break;
        }
    }
